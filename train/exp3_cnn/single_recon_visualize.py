"""Shared visualization for single-signal masked reconstruction (Exp3 ECG/rPPG split)."""
...
from single_recon_train import build_single_window_visible_mask
...
def run_visualization(signal_type, exp_name):
    ...
    fig.suptitle(
        f"{exp_name} Masked Reconstruction ({channel_label})\\n"
