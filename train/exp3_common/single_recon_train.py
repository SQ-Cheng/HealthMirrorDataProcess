"""Shared training loop for Exp3 single-signal masked reconstruction (all architectures)."""
...
def parse_args(exp_name, description_suffix=""):
    desc = f"{exp_name}: single-signal masked reconstruction{description_suffix}"
...
def run_experiment(
    ...
    args = parse_args(exp_name, description_suffix=description_suffix)
