"""Shared training loop for Exp3 Mamba split experiments (ECG-only / rPPG-only)."""
...
def parse_args(exp_name):
    parser = argparse.ArgumentParser(description=f"{exp_name}: single-signal masked reconstruction (Mamba)")
