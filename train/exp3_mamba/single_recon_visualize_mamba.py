"""Shared visualization for single-signal masked reconstruction (Exp3 ECG/rPPG Mamba split)."""
...
from single_recon_model_mamba import build_single_recon_mamba_model
from single_recon_train_mamba import build_single_window_visible_mask
...
def run_visualization(signal_type, exp_name):
    ...
    model = build_single_recon_mamba_model(args.variant).to(DEVICE)
    ...
    fig.suptitle(
        f"{exp_name} Mamba Masked Reconstruction ({channel_label})\\n"
