"""Shared visualization for single-signal masked reconstruction (Exp3 ECG/rPPG Transformer split)."""
...
from single_recon_model_transformer import build_single_recon_transformer_model
from single_recon_train_transformer import build_single_window_visible_mask
...
def run_visualization(signal_type, exp_name):
    ...
    model = build_single_recon_transformer_model(args.variant).to(DEVICE)
    ...
    fig.suptitle(
        f"{exp_name} Transformer Masked Reconstruction ({channel_label})\\n"
