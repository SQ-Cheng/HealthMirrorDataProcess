"""Baseline UNet-style model for single-signal masked reconstruction.

Architecture: U-Net with skip connections, dilated residual blocks in bottleneck.
...
class SingleReconNetLight(nn.Module):
    """U-Net-like lightweight model for single-channel masked reconstruction."""
...
class SingleReconNetFull(nn.Module):
    """U-Net-like moderate-capacity model with deeper encoder and skip connections."""
...
def build_baseline_model(variant="light"):
    """Build a baseline UNet model.
