"""Run the matched change-direction analysis for the trained face-only model."""
...
INPUT_DIR = EXPERIMENT_DIR / "outputs/20frame"
HISTORY_DIR = (
...
def main():
    run(
        ...
        model_label="Face-only Head32 regression",
    )
