...
| --- | --- | --- |
| `exp2_binary_allframes_head32_views5` | `exp2_face_pretrained_allframes_head32` | Completed five-view binary reference |
| `exp2_binary_allframes_head32_views3` | `exp2_face_pretrained_allframes_head32_views3` | Completed primary binary experiment |
| `exp2_regression_allframes_head32_single_task` | `exp2_face_pretrained_allframes_head32_regression` | Completed distribution-balanced single-task regression |
...
- `exp2_face_pretrained_allframes_head32/outputs/frame_index`: current compact
  all-frame MJPEG byte-offset index

The original multimodal experiment, initial grayscale face models, 96-pixel Aug20
models, 20-frame pretrained experiments, obsolete monitors, and their generated
