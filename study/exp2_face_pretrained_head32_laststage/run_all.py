"""Run aligned raw-video 20-frame Head-32 Last-Stage binary jobs."""
...
def main():
    ...
    experiment_manifest = {
        "schema_version": 1,
        "experiment": "exp2_face_pretrained_head32_laststage",
        ...
        "training": {
            ...
            "stage_2": (
                "classification head plus final semantic backbone stage, "
            ...
            "frozen_batchnorm_policy": (
                ...
                "stage and classification head enter train mode"
            ),
    ...
    from study.exp2_face_pretrained_head32_laststage.plot_results import main as plot_results
